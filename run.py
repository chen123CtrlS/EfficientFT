...
import datasets
# import evaluate
from peft import LoraConfig, get_peft_model, AdaLoraConfig, EvaConfig, IA3Config
...
#TODO: Load pretrained model and tokenizer
    ...
    if training_args.use_lora and training_args.method_name != 'sift':
        ...
        if training_args.method_name == 'lora':
        ...
        elif training_args.method_name == 'pissa':
            peft_config = LoraConfig(
            ...
            lora_dropout=training_args.lora_dropout,
            modules_to_save=["classifier", "score"])
        elif training_args.method_name == 'olora':
            peft_config = LoraConfig(
            ...
            lora_dropout=training_args.lora_dropout,
            modules_to_save=["classifier", "score"])
        elif training_args.method_name == 'eva':
            peft_config = LoraConfig(
            ...
            lora_dropout=training_args.lora_dropout,
            modules_to_save=["classifier", "score"])
        elif training_args.method_name == 'dora':
            peft_config = LoraConfig(
            use_dora=True,
            task_type="SEQ_CLS",
            fan_in_fan_out=True,
        ...
        elif training_args.method_name == 'rslora':
            peft_config = LoraConfig(
            use_rslora=True,
            task_type="SEQ_CLS",
            fan_in_fan_out=True,
        ...
        elif training_args.method_name == 'adalora':
            ...
            lora_dropout=training_args.lora_dropout,
            modules_to_save=["classifier", "score"],
            init_r=3*training_args.lora_rank #2r~3r
        )
        elif training_args.method_name == 'ia3':
        ...
        target_modules = target_modules.split(",")
        target_modules = [target_module.strip() for target_module in target_modules]
        if training_args.method_name == 'sift':
            sift = SIFT(model, sparse_rate=0.2,
